      ...
      <section className="group/hero relative overflow-hidden bg-slate-900 px-4 py-16 sm:px-6 sm:py-20 transition-all duration-500 hover:bg-slate-800">
        ...
        <div className="relative mx-auto max-w-4xl text-center transition-transform duration-300 group-hover/hero:scale-[1.01]">
          ...
          <p className="mt-4 text-lg text-slate-300">
            Have a question or ready to start? Get in touch.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="space-y-8">
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    ...
                    <a
                      ...
                      className="block text-slate-900 font-medium hover:text-amber-600"
                    >
                      {siteConfig.email}
                    </a>
                  </li>
              ...
              <a
                ...
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#25D366] px-6 py-4 font-semibold text-white shadow-md transition hover:bg-[#20bd5a]"
              >
                <svg
                  className="h-6 w-6"
                  fill="currentColor"
                  ...
                  <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        required
                        className="mt-1 block w-full rounded-xl border border-slate-300 px-4 py-2.5 shadow-sm focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                      />
                    </div>
                    <div>
                      <label
